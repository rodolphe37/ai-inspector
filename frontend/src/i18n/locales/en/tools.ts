export const clean = {
  ...
  ops: {
    ...
    trimDesc: 'Remove trailing spaces and tabs and collapse blank-line runs (kept in code, Markdown hard breaks preserved).',
  ...
  legend: 'In the preview below, each invisible character is shown as a small label (ZW, SP, BIDI…) and each suspicious letter is highlighted in red.',
  charNames: {
    u200b: 'Zero-width space',
    u200c: 'Zero-width non-joiner',
    u200d: 'Zero-width joiner',
    u2060: 'Word joiner',
    ufeff: 'Byte order mark (zero-width no-break space)',
    u00ad: 'Soft hyphen',
